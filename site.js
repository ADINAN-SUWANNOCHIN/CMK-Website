...
const WORKS = [
  ...
  {en:"Magilumiere Magical Girls Inc.", cat:"anime", owner:"company", img:"magilumiere.jpg"},
  {en:"From Old Country Bumpkin to Master Swordsman", cat:"anime", owner:"company", img:"country-bumpkin-swordsman.jpg"},
  {en:"The Demon King's Daughter is Too Kind!!", cat:"anime", owner:"company", img:"demon-kings-daughter.jpg"},
  {en:"An Adventurer's Daily Grind at Age 29", cat:"anime", owner:"company", note:"S1", img:"adventurer-age-29.jpg"},
  {en:"A Misanthrope Teaches a Class for Demi-Humans", cat:"anime", owner:"company", note:"S1", img:"misanthrope-demi-humans.jpg"},
  {en:"The Villainess Is Adored by the Prince", cat:"anime", owner:"company", note:"S1", img:"villainess-adored.jpg"},
  {en:"In the Clear Moonlit Dusk",     cat:"anime", owner:"company", note:"S1", img:"clear-moonlit-dusk.jpg"},
  {en:"Roll Over and Die",             cat:"anime", owner:"company", note:"S1", img:"roll-over-and-die.jpg"},
  {en:"Kunon the Sorcerer Can See Through", cat:"anime", owner:"company", note:"S1", img:"kunon-sorcerer.jpg"},
  {en:"New Saga",                      cat:"anime", owner:"company", note:"S1", img:"new-saga.jpg"},
  {en:"Release That Witch",            cat:"anime", owner:"company", note:"S1", img:"release-that-witch.jpg"},
  {en:"An Observation Log of My Fiancée", cat:"anime", owner:"company", note:"S1", img:"observation-log-fiancee.jpg"},
  {en:"Eren the Southpaw",             cat:"anime", owner:"company", note:"S1", img:"eren-southpaw.jpg"},
  {en:"The Warrior Princess and the Barbaric King", cat:"anime", owner:"company", note:"S1", img:"warrior-princess-barbaric-king.jpg"},
  {en:"From Overshadowed to Overpowered", cat:"anime", owner:"company", note:"S1", img:"overshadowed-overpowered.jpg"},
  {en:"Heroine? Saint? No, I'm an All-Works Maid (And Proud of It)!", cat:"anime", owner:"company", note:"S1", img:"all-works-maid.jpg"},
  {en:"I Became a Legend after My 10 Year-Long Last Stand", cat:"anime", owner:"company", note:"S1", img:"became-a-legend.jpg"},
  {en:"Oh Boy, Was I Wrong About Her", cat:"anime", owner:"company", note:"S1", img:"wrong-about-her.jpg"},
  {en:"The Duke's Son Claims He Won't Love Me", cat:"anime", owner:"company", note:"S1", img:"dukes-son.jpg"},
  {en:"The Insipid Prince's Furtive Grab for the Throne", cat:"anime", owner:"company", note:"S1", img:"insipid-prince.jpg"},
...
const SPECIALS = [
  ...
  },
  {
    ...
    cast: [
      ...
      {img:'krut-nalinee.jpg',  nameKey:'sp.k4', role:'กนกนารี'},
      {img:'krut-sanohthip.jpg',nameKey:'sp.k5', role:'เจ้าพระยากลาโหม / กาลรากษส'},
      {img:'krut-piya.jpg',     nameKey:'sp.k6', role:'อสูรทมิฬ'},
    ]
  },
...
const I18N = {
  th: {
    ...
    "sp.k1":"ณเดชน์ คูกิมิยะ","sp.k2":"รอง เค้ามูลคดี","sp.k3":"มนตรี เจนอักษร","sp.k4":"นลินี ชีวะสาคร","sp.k5":"เสนาะทิพย์ วงศ์ศิริจินดา","sp.k6":"ปิยะ ชำนาญกิจ",
